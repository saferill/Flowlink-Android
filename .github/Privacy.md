...
Thank you for using our application "FlowLink". Your privacy is important to us. This Privacy Policy explains how our App collects, uses, and protects your information. By using our App, you agree to the practices described in this policy.

## Information We Collect

FlowLink collects and processes the following data **locally on your device** and, when connected, over your **local network** to your Windows PC:
...
All data processed by FlowLink is:
...
| `REQUEST_IGNORE_BATTERY_OPTIMIZATIONS` | Used so that the system does not stop the FlowLink background service, helping maintain a stable connection. |
...
| Permission | Purpose |
|------------|--------|
| `BIND_NOTIFICATION_LISTENER_SERVICE` | Allows FlowLink to read your notifications and forward them to your Windows app. |
...
Because FlowLink does not collect or store your data on external servers, there is no central account or cloud data to delete or export. All processing is local and between your own devices; you control pairing, permissions, and which features (e.g. SMS, clipboard, notifications) are enabled per device.

## Contact

If you have questions about this Privacy Policy or how FlowLink works, you can reach us at:

- **Email**: safe_rill@gmail.com

- **Discord**: [FlowLink Discord server](https://discord.gg/MuvMqv4MES)
