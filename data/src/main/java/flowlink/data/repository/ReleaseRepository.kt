package FlowLink.data.repository
...
import FlowLink.domain.model.GitHubReleaseResponse
import FlowLink.domain.model.Release
import FlowLink.network.NetworkHelper
    ...
    suspend fun getRelease(currentVersion: String): Result {
        try {
            ...
            val response = networkHelper.client.get(
                "https://api.github.com/repos/safe_rill/FlowLink-Android/releases/latest"
            ) {
