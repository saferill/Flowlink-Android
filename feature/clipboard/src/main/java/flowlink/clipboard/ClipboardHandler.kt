...
import FlowLink.common.util.createTempFile
import FlowLink.common.util.getFileProviderUri
        ...
        try {
            val clip: ClipData = when {
                ...
                clipboard.clipboardType.startsWith("image/") -> {
                    ...
                    val tempFile = createTempFile(context, "FlowLink_clipboard_image", extension)
