...
import FlowLink.domain.model.NotificationTextMessage
...
import FlowLink.common.util.bitmapToBase64
import FlowLink.common.util.drawableToBase64
import FlowLink.common.util.drawableToBitmap
...
class NotificationService @Inject constructor(
    ...
    private fun sendNotification(sbn: StatusBarNotification, notificationInfoType: NotificationInfoType, targetDeviceIds: Set<String>) {
        ...
        if ("com.castle.FlowLink" == packageName) {
