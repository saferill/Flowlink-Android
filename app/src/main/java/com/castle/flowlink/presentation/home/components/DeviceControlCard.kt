package com.castle.FlowLink.presentation.home.components
...
import FlowLink.presentation.components.Button
import FlowLink.presentation.components.TextButton
...
private fun getIconForAction(actionId: String): ImageVector {
    return when (actionId?.lowercase()) {
        ...
        "close_all", "close_all_apps", "closeall" -> Icons.AutoMirrored.Filled.Logout
